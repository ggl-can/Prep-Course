...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí   
  var laboral = "23456";
  if(laboral.includes(numeroDeDia)) {return "Es dia Laboral";}
...
function mesesDelAño(array) {
  ...
  // Tu código:
var mesPedidos = ["Enero", "Marzo" , "Noviembre"];
var encontrados= [];
...
function breakStatement(numero) {
  ...
  for (var i=0; i< 10; i++){ 
       N.push(numero +=2);
       if (numero === (i+1)) { inter=true;  break; } 
      }
      if (inter ) {return "Se interrumpió la ejecución";}
      else return N; 
}
